			...
			<h2></h2>
				<div class="inner">
					<div class="form-content">
						...
						<p>Pengisian kuisioner telah sukses, terima kasih Anda telah mengisi kuisioner kami.</p>
						<div class="form-row">
							<a class="text-center" href="javascript:void(0)" id="gotologin"><p>Kembali ke halaman utama</p></a>
						</div>
					</div>
				</div>
		</form>
